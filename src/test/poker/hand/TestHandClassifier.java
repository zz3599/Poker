...
public class TestHandClassifier {
	...
	public void TestStraightFlush(){
		Card[] communityCards = new Card[]{
				...
				new Card(Suite.CLUBS, 6),
				new Card(Suite.CLUBS, 2), 
				new Card(Suite.CLUBS, 3),				
				new Card(Suite.HEARTS, 7)
		};
		Hand hand = new Hand(new Card(Suite.CLUBS, 4), new Card(Suite.CLUBS, 5));
	...
	public void TestFourOfAKind(){
		Card[] communityCards = new Card[]{
				...
				new Card(Suite.SPADES, 4),				
				new Card(Suite.CLUBS, 4)
		};		
		Hand hand = new Hand(new Card(Suite.DIAMONDS, 3), new Card(Suite.SPADES, 3));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
	...
	public void TestFullHouse(){
		Card[] communityCards = new Card[]{
				new Card(Suite.HEARTS, 3),
				new Card(Suite.CLUBS, 7),
				new Card(Suite.HEARTS, 4), 
				new Card(Suite.SPADES, 4),				
				new Card(Suite.CLUBS, 8)
		};
		Hand hand = new Hand(new Card(Suite.DIAMONDS, 3), new Card(Suite.CLUBS, 4));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
	...
	public void TestStraight(){
		Card[] communityCards = new Card[]{
				...
				new Card(Suite.DIAMONDS, 14)
		};
		Hand hand = new Hand(new Card(Suite.HEARTS, 11), new Card(Suite.DIAMONDS, 12));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
	...
	public void TestThreeOfKind(){
		Card[] communityCards = new Card[]{
				...
				new Card(Suite.SPADES, 3),				
				new Card(Suite.CLUBS, 4),
				new Card(Suite.HEARTS, 7),
				new Card(Suite.DIAMONDS, 8)
		};
		Hand hand = new Hand(new Card(Suite.DIAMONDS, 2), new Card(Suite.SPADES, 2));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
	...
	public void TestTwoPair(){
		...
		Hand hand = new Hand(new Card(Suite.DIAMONDS, 2), new Card(Suite.HEARTS, 8));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
	...
	public void TestOnePair(){
		...
		Hand hand = new Hand(new Card(Suite.DIAMONDS, 2), new Card(Suite.HEARTS, 14));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
	...
	public void TestHighCard(){
		...
		Hand hand = new Hand(new Card(Suite.DIAMONDS, 13), new Card(Suite.HEARTS, 14));
		HandClassification classification = classifier.getHandClassification(Arrays.asList(communityCards), hand);
